...
func TestDB_NewIterator(t *testing.T) {
	...
	iterator := db.NewIterator(settings.Conf.IteratorConfig)
...
func TestDB_Iterator_Multi_Values(t *testing.T) {
	...
	// 正向迭代
	iter1 := db.NewIterator(settings.Conf.IteratorConfig)
	...
	// 反向迭代
	iterOpts1 := settings.Conf.IteratorConfig
	...
	// 指定了 prefix
	iterOpts2 := settings.Conf.IteratorConfig
